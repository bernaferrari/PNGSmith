...
<p align="center">
  <img src="docs/assets/readme-hero.png" alt="PNG Smith" width="100%">
</p>

PNG Smith is a native macOS app for making PNG files smaller. It grew out of a habit I picked up in Pixelmator Pro: exporting PNGs with Advanced Compression enabled and a 256-color limit. The results were often dramatically smaller, and I never saw a visual difference.

PNG Smith turns that workflow into a focused app. Drop in an image or a whole folder, try color reduction, compare the result with the original, then save a copy or replace the source. Images that need every original color can use fully lossless compression instead.

<p align="center">
  <img src="docs/assets/demo.webp" alt="PNG Smith comparison and color reduction workflow" width="1000">
</p>
...
- **Animated PNG support** — Preserve every frame; PNG Smith automatically uses lossless compression
- **macOS automation** — Use PNG Smith from Finder Quick Actions, Services, Shortcuts, or the CLI
- **Session restore** — Reopen the images from your previous session

<p align="center">
  <img src="docs/assets/batch-review-dark.png" alt="PNG Smith reviewing three compressed images in dark mode" width="1000">
</p>
...
<p align="center">
  <img src="docs/assets/compression-preview-dark.png" alt="PNG Smith compressing a PNG in dark mode" width="1000">
</p>
...
<p align="center">
  <img src="docs/assets/crop-editor-dark.png" alt="PNG Smith crop editor at 342% zoom" width="1000">
</p>
